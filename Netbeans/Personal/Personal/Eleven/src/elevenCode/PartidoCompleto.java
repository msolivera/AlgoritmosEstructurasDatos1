...
public class PartidoCompleto {
    ...
    Lista<Jugador> jugadoresLocal;
    Lista<Jugador> jugadoresVisitante;
    //vectores que guardan los id de los jugadores del equipo local y visitante
    int[] jugadoresLocalId;
    int[] jugadoresVisitanteId;
     ...
     */
    String[] posicionesLocal;
    String[] posicionesVisitante;
    ...
    public void mostrarInfo() {
        ...
        Nodo<Jugador> aux = this.jugadoresLocal.getPrimero();
        ...
        Nodo<Jugador> aux2 = this.jugadoresVisitante.getPrimero();
