...
public class Jugador {
    ...
    public void mostrarInfo() {
        ...
        if (!this.susEvento.esVacia()) {
            ...
            Nodo<Evento> evento = this.susEvento.getPrimero();
        ...
        if (!this.susLigas.esVacia()) {
            ...
            Nodo<Liga> liga = this.susLigas.getPrimero();
    ...
    public void infoLigas() {
        ...
        if (!this.susLigas.esVacia()) {
            ...
            System.out.println("SIN INFORMACION RELACIONADA.");
        }
    }
