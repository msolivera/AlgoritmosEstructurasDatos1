...
public class Parcial {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String lineas;
        try {
            archivo = new File("src\\parcial1\\basico-ing.txt");
        ...
        String lineas2;
        try {
            archivo2 = new File("src\\parcial1\\basico-emp.txt");
        ...
        FileWriter fw;
        try {
            fw = new FileWriter("src\\parcial1\\integrador101.txt", true);
        ...
        FileWriter fw2;
        try {
            fw2 = new FileWriter("src\\parcial1\\exigente102.txt", true);
