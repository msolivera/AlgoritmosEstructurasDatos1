...
public class TArbolBB<T> implements IArbolBB<T> {
    ...
    /**
     * Si "c" = true, inserta unElemento en el arbol contando la cantidad de invocaciones que se realizan.
    ...
    /**
     * 
     * Si "c" = true, busca unaEtiqueta en el arbol contando la cantidad de invocaciones que se realizan.
