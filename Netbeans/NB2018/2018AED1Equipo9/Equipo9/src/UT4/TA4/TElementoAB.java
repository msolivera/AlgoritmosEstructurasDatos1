...
class TElementoAB implements IElementoAB
{
    ...
    public int obtenerCantidadHojas() {
        if(this.hijoDer == null && this.hijoIzq == null){
            ...
            if(this.hijoDer != null && this.hijoIzq != null){
                return this.hijoDer.obtenerCantidadHojas() + this.hijoIzq.obtenerCantidadHojas();
            }
            else {
                if(this.hijoDer != null){
                    return this.hijoDer.obtenerCantidadHojas();
                }
                else {
                    return this.hijoIzq.obtenerCantidadHojas();
                }
    ...
    @Override
         ...
         public int obtenerNivel(Comparable unaEtiqueta, Integer variable) {
         if(etiqueta.compareTo(unaEtiqueta)== 0)
        {
            return variable;
        }
        else{
            if(etiqueta.compareTo(unaEtiqueta) == -1)
            {
                if(hijoIzq==null)
                {
                    return -1;
                ...
                {
                    return hijoIzq.obtenerNivel(unaEtiqueta, variable + 1);
                }
            }
            else
            {
                ...
                {
                    return hijoDer.obtenerNivel(unaEtiqueta, variable + 1);
                }
            }
        }
