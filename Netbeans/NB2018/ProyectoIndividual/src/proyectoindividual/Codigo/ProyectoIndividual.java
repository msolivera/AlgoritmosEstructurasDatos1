...
public class ProyectoIndividual {
    ...
    public static void main(String[] args) {
        ...
        libreria.cargarAutores("src/ProyectoIndividual/DataBase/authors.csv");
        libreria.cargarLibros("src/ProyectoIndividual/DataBase/books.csv");
        libreria.cargarTags("src/ProyectoIndividual/DataBase/tags.csv");
